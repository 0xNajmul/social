...
import { Check, Edit3, Plus, Star, Trash2 } from 'lucide-react'
...
export default function Plans() {
  ...
  const load = () => api.get('/admin/plans').then(({ data }) => setPlans(data.data))
  useEffect(() => { load() }, [])
